        ...
        <footer className='bg-dark d-flex flex-lg-row flex-column justify-content-around align-items-center mt-auto pb-5 py-lg-5'>
            <div className="followmeon text-white my-5">
                ...
                <div className="socials d-flex flex-wrap gap-1 justify-content-center">
                    <div className="social"><a href='https://www.facebook.com/khandaker330' target="_blank" rel="noreferrer"><img src={social_1} alt="" /></a></div>
                    <div className="social"><a href='https://github.com/KnsDev330' target="_blank" rel="noreferrer"><img src={social_2} alt="" /></a></div>
                    <div className="social"><a href='https://www.instagram.com/KnsDev330' target="_blank" rel="noreferrer"><img src={social_3} alt="" /></a></div>
                    ...
                    <div className="social"><a href='https://twitter.com/KnsDev' target="_blank" rel="noreferrer"><img src={social_6} alt="" /></a></div>
                </div>
            </div>
            ...
            <div className="gettheapp text-white d-flex flex-column align-items-center gap-2">
                ...
                <div><a href='https://play.google.com/store/apps/details?id=com.tencent.ig' target="_blank" rel="noreferrer"><img src={playstore} alt="" /></a></div>
                <div><a href='https://apps.apple.com/us/app/pubg-mobile/id1330123889' target="_blank" rel="noreferrer"><img src={appstore} alt="" /></a></div>
            </div>
        </footer>
    );
};
